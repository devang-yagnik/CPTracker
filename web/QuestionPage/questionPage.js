        ...
        .then((data) => {
            ...
            if (data.status === "OK") {
                ...
                problems.forEach((problem) => {
                    ...
                    row.innerHTML = `
                      <th class="flex gap-3 px-6 py-4 font-normal text-gray-900" id="${problem.index}th">
                          <div class="text-sm">
                        ...
                        <td class="px-6 py-4">
                          ...
                          <td class="px-6 py-4">
                            <div class="flex">
                            <button type="button" id="${problem.index}" onclick="passDataToDatabase(this.id)" class="text-blue-700 border border-blue-700 hover:bg-blue-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:focus:ring-blue-800 dark:hover:bg-blue-500">
...
let passDataToDatabase = (clickedIndex) => {
    
    $.ajax({
        type: "post",
        url: "../store_todo", //this is my servlet
        data: {
            problemIndex: clickedIndex,
            contestID: $("#contestID").val()
        },
        success: function () {
            document.getElementById(clickedIndex +"th").parentElement.className = "bg-green-100";
            document.getElementById(clickedIndex).className = "bg-black-100";
            document.getElementById(clickedIndex).disabled = true;
        }
    });
};
